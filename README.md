...
- Telas de Fichas, Apadrinhamento, Sacolas, Check-in e Contatos adaptadas para mobile com cards, filtros recolhíveis e ações touch-friendly.
...
- **Continuar o ajuste do layout geral para mobile** nas telas de Usuários, Campanhas, Relatórios, Dashboard e ficha individual. O drawer e as telas de Fichas, Apadrinhamento, Sacolas e Check-in já foram adaptados.
